...
optimizerD = optim.netR(netR.parameters(), lr=opt.lr, betas =(opt.beta1,0.999))
#optimizerU = optim.Adam([param for net in Gnets for param in list(net.parameters())], lr=opt.lr, betas=(opt.beta1, 0.999))
optimizerU = optim.netR([param for net in Gnets for param in list(net.parameters())],lr =opt.lr, betas=(opt.beta1, 0.999))
